...
public class Manufacturer  {
    ...
    public static final int ABAWO = 151;
    public static final int BAFANG = 152;
    ...
    public static final int LSEC = 320; // Lishun Electric & Communication
    ...
    public static final int EO_SWIMBETTER = 330;
    public static final int MYWHOOSH = 331;
    public static final int RAVEMEN = 332;

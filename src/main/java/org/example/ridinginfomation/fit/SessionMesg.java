...
public class SessionMesg extends Mesg implements MesgWithEvent   {
    ...
    static {
        ...
        field_index++;
        sessionMesg.addField(new Field("workout_feel", WorkoutFeelFieldNum, 2, 1, 0, "", false, Profile.Type.UINT8));
        field_index++;
        sessionMesg.addField(new Field("workout_rpe", WorkoutRpeFieldNum, 2, 1, 0, "", false, Profile.Type.UINT8));
        field_index++;
     ...
     */
    public void setWorkoutFeel(Short workoutFeel) {
     ...
     */
    public void setWorkoutRpe(Short workoutRpe) {
